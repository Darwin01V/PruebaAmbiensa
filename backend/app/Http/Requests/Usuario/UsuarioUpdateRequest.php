    ...
    public function rules(): array
    {
        ...
        return [
            'n_identificacion' => [
                ...
                'required',
                'string',
                Rule::unique('users', 'n_identificacion')->ignore($userId)
            ],
            ...
            'num_movil' => ['sometimes', 'required', 'string', 'max:15', 'min:10'],
            'num_fijo' => ['sometimes', 'required', 'string', 'max:15', 'min:7'],
            'email' => [
                'sometimes',
                'required',
                'string',
            ...
            'direccion' => ['sometimes', 'required', 'string', 'min:5', 'max:255'],
        ];
    }
